...
public class ProjektMeny extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtSökPerson = new javax.swing.JTextField();
        btnSökPerson = new javax.swing.JButton();
        lblSökPerson = new javax.swing.JLabel();
        ...
        txtSökPerson.setMinimumSize(new java.awt.Dimension(100, 24));

        btnSökPerson.setText("Sök");
        btnSökPerson.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSökPersonActionPerformed(evt);
            }
        });

        lblSökPerson.setText("Sök personID:");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(lblSökPerson)
                        .addGap(18, 18, 18)
                        .addComponent(txtSökPerson, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(btnSökPerson, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtSökPerson, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnSökPerson)
                    .addComponent(lblSökPerson))
...
//                nyttProjekt.taBortProjekt(queryPid);    //metod för att faktiskt ta bort projekt från databasen
    ...
    private void btnSökPersonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSökPersonActionPerformed
        boolean validering = Validering.faltEjTomtKontroll(txtSökPerson);
        if (validering) {
            try {
                hamtaProjekt(Integer.parseInt(txtSökPerson.getText()));
            }
            catch (Exception ex){
                JOptionPane.showMessageDialog(null, "Inga projekt för denna person");
            }
        }
    }//GEN-LAST:event_btnSökPersonActionPerformed
    ...
    private void hamtaProjektSomProjektChef(int aid) {
        try {
            ArrayList<HashMap<String, String>> resultat = nyttProjekt.getAllaProjektSomProjektChef(aid);
    ...
    private javax.swing.JButton btnSökPerson;
    ...
    private javax.swing.JLabel lblSökPerson;
    private javax.swing.JTable tblProjekt;
    private javax.swing.JTextField txtSökPerson;
