...
public class Huvudmeny extends javax.swing.JFrame {
    ...
    private void fyllFunFacts() {
        funFacts.add("Det här projektet har hittills haft 145 pull requests och över 200 commits i GitHub");
        ...
        funFacts.add("Oracle som äger Java, men som med mycket annat de har idag inte skapade det, står också bakom Millenium som just nu är det mest hatade programmet inom svensk, och troligen även internationell, hälsovård.");
        funFacts.add("Larry Ellison, Oracles gundare har en förmögenhet på 208 miljarder dollar och har skapat det genom att bygga en databasplattform som är väldigt stabil, men också är låst bakom ett licenssystem som ingen normal människa förstår sig på och oavsett hur bra pålitlighet den har känns den aldrig värt pengarna.");
        funFacts.add("Oracle äger även varumärket JavaScript, men det har inget med Java att göra utan det fick det på köpet när de köpte upp Sun Microsystems, som i sin tur köpte det av Netscape.");
        funFacts.add("Oracle fick rättigheterna till MySQL när de köpte Sun Microsystems 2010, men när det skedde valde utvecklaren att skapa en fork på MySQL som de sedan döpte till MariaDB.");
    }
